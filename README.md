...
A test project for exploring agentic development workflows. Zero code written by hand — everything is generated by Claude (Sonnet) and validated through automated gates:

- **Pre-commit:** secret scanning (gitleaks + detect-secrets), linting, and full test suite
- **Pre-merge:** automated PR review by a Claude agent

The goal is to demonstrate how code and product quality can be maintained — and improved over time — with an agentic coding workflow.
